...
(define (script-fu-my-sphere-labb radius
			  light
			  shadow
			  sphere-color)
  ...
  (let* ((width (* radius 3.75))
	 ...
	 (drawable (car (gimp-layer-new img width height RGBA-IMAGE
...
(script-fu-register "script-fu-my-sphere-labb"
		    "Enkelt klot labb variant"
...
(script-fu-menu-register "script-fu-my-sphere-labb"
